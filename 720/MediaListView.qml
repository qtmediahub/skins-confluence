...
Item {
    ...
    ContextMenu {
        ...
        ConfluenceAction { id: removeAction; text: qsTr("Remove"); onActivated: { console.log(sourcesListView.currentIndex); engineModel.removeSearchPath(sourcesListView.currentIndex) } }
    ...
    Panel {
        ...
        TreeView {
            ...
            onRightClicked: {
                ...
                console.log(scenePos.x + ' ' + scenePos.y)
