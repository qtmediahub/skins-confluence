...
Blade {
    ...
    resources: ListModel {
        id: optionsModel
        ListElement { name: QT_TR_NOOP("VIEW"); type: "view"; options: "LIST,BIG LIST,THUMBNAIL,PIC THUMBS,IMAGE WRAP,POSTER"; currentOption: 0} // cannot assign js array :/
    ...
    content: Column {
        ...
        ConfluenceListView2 {
            ...
            model: optionsModel
            translationContext: "VideoWindowBlade"
            onActivated: {
